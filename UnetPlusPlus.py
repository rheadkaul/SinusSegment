...
class UnetPlusPlus(nn.Module):
    def __init__(self, stack,num_classes, deep_supervision=False):
        ...
        self.stage_0 = ContinusParalleConv(stack, 64, pre_Batch_Norm=False)
    ...
    def forward(self, x):
        ...
        if self.deep_supervision:
            ...
            return [nn.Sigmoid()(out_put1), nn.Sigmoid()(out_put2), nn.Sigmoid()(out_put3), nn.Sigmoid()(out_put4)]
        else:
            return nn.Sigmoid()(self.final_super_0_4(x_0_4))
